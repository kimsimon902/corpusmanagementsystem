...
urlpatterns =[
    ...
    path('publication/<id>/addkeywordRequest',views.addKeyword, name = 'addkeyword'),
    path('publication/<id>/removekeywordRequest/<keyword>',views.removeKeyword, name = 'removekeyword'),
