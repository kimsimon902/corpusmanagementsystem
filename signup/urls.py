...
urlpatterns =[
    ...
    path('folders/<username>/<folderid>/publication/<id>/annotate',views.PublicationPageAnnotate, name ='publicationpageannotatee'),
    ...
    path(r'^delete/(?P<part_id>[0-9]+)/$', views.statusAdmin, name='delete_view')
]
