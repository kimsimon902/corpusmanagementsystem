...
urlpatterns =[
    ...
    path('publication/<id>/addkeyword/<keyword>',views.addKeyword, name = 'addkeyword'),
    path('publication/<id>/removekeyword/<keyword>',views.removeKeyword, name = 'removekeyword'),
