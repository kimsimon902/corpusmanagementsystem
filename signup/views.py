...
all_stopwords.append('HTML')
all_stopwords.append('xhtmlspan')
all_stopwords.append('htmlheadscript')
all_stopwords.append('contenttexthtml')
...
def downloadFolderTable(request):
    ...
    if request.method == 'POST':
        ...
        bc.categoryAxis.categoryNames = set(yearcat)
