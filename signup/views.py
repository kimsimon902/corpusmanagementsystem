...
def downloadFolderTable(request):
    ...
    if request.method == 'POST':
        ...
        for pub in getpubs:
            data.append([pub.title,Paragraph(pub.author, styleN),Paragraph(pub.abstract, styleN),Paragraph(pub.url, styleN),Paragraph(pub.source, styleN),Paragraph(pub.year, styleN)])
